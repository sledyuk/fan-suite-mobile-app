...
export const CONVERSATIONS: Conversation[] = [
  { id: 'rick', fan: fan('Rick Sanchez', '@rickc137', rmAvatar(1), true), seed: 42,
  ...
  { id: 'birdperson', fan: fan('Birdperson', '@birdperson', rmAvatar(47), true), seed: 11,
  ...
  { id: 'beth', fan: fan('Beth Smith', '@dr_beth', rmAvatar(4), true), seed: 17,
  ...
  { id: 'unity', fan: fan('Unity', '@one_mind', rmAvatar(372), true), seed: 23,
